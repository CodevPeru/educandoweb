...
<head>
	...
	<title>Registrar Suspensiones</title>
...
<body onload="parametro(1)">
	<nav>
	  <ul>
	    ...
	    <li class='user'>
	      <a hhref='frmRegistroActividad.php'>
	    ...
	    <li class='suspensiones'>
	      <a href='frmRegistrarSuspensiones.php' id="menucolor">
	...
	<div class="container">
		...
		<div class="col-lg-8">
			...
			<textarea class="form-control" name="txtsuspension" id="txtsuspension">
				
			</textarea><br>
			<label>Fecha de Inicio Suspensión:</label>
			<input type="text" class="form-control" name="txtfecha" id="txtfecha"><br>
			<label>Fecha Fin Suspensión:</label>
			<input type="text" class="form-control" name="txtfin" id="txtfin"><br>
