...
<body onload="parametro(1);">
	<nav>
	  <ul>
	    ...
	    <li class='personal'>
	      <a href='frmPermisosPersonal.php' id="menucolor">
	...
	<div class="container">
		...
		<div class="col-lg-8">
			...
			<label>Motivo:</label>
			<textarea class="form-control" name="txtmotivo" id="txtmotivo">
				
			</textarea><br>
			<label>Fecha:</label>
			<input type="text" class="form-control" name="txtfecha" id="txtfecha"><br>
			<label>Hora:</label>
			<input type="text" class="form-control" name="txthora" id="txthora"><br>
			<button class="btn btn-lg btn-success center-block">Guardar</button>
		</div>
		<div class="col-lg-2"></div>
	</div>	
	<!-- Template js -->
